<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-6 space-y-6">
        <h1 class="text-3xl font-bold">自己選択とフィードバック (Step 2)</h1>

        <!-- フィードバック依頼 -->
        <div class="bg-white shadow rounded-lg p-6">
            <h2 class="text-xl font-semibold mb-4">フィードバック依頼</h2>
            <form id="feedbackForm" class="flex gap-2 mb-4">
                @csrf
                <input 
                    type="email" 
                    name="email" 
                    ...
                    required>
                <button type="button" id="requestButton" class="bg-blue-500 text-white px-4 py-2 rounded flex items-center">
        ...
        <!-- フィードバック一覧 -->
        <div class="bg-white shadow rounded-lg p-6">
            <h2 class="text-xl font-semibold mb-4">フィードバック一覧</h2>
            <div class="space-y-4">
        ...
        <div id="modal" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg shadow p-6 w-96">
                ...
                <div class="flex justify-end gap-2">
                    <button id="cancelButton" class="bg-gray-300 px-4 py-2 rounded">キャンセル</button>
                    <button id="confirmButton" class="bg-blue-500 text-white px-4 py-2 rounded">送信する</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        confirmButton.addEventListener('click', () => {
            ...
            newRequest.className = 'flex items-center justify-between bg-gray-100 p-3 rounded';
